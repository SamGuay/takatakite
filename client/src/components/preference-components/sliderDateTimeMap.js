...
class SliderDateTimeMap extends Component {
    ...
    click(index,date){
        ...
        let dateLength=(this.props.apiTime.length)-1
  ...
  export default (withStyles(styles)(connect(mapStateToProps,mapDispatchToProps)(SliderDateTimeMap)));