...
class SpotFilterForMap extends Component {
    constructor(){
        super()
        this.state={
            spotBars:[],
    ...
    componentWillMount(){
        ...
        if(this.props.pathName==='/pages/mapPage' &&  this.props.apiWeather.loaded ){
...
export default connect(mapStateToProps,mapDispatchToProps)(SpotFilterForMap);
