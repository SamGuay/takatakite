...
import imageUrl from '../../img/coconut.jpg';
...
class EcoleKite extends Component {
      ...
      return (
        <div className="col-lg-4 col-sm-6" key={index}>
          <div className="an-service-single">
            ...
            <img src={link} alt={'spot'} style={{border: '3px solid rgb(216, 61, 87)',borderRadius: '50%', width:'100%', height:'100%', boxShadow:'rgba(0, 0, 0, 0.12) 0px 1px 6px, rgba(0, 0, 0, 0.12) 0px 1px 4px'}}/>
            </div>
            <h4>{ecole.name}</h4>
              <div style={{display:'inline', textAlign:'left'}}>
                ...
                <p style={{lineHeight:'1.5',fontSize:'0.8rem'}}><span style={{color:'rgb(50, 50, 50)',fontWeight:'500', lineHeight:'1.5'}}> Marque de kite: </span>{ecole.equipmentBrand}</p>
                <p style={{lineHeight:'1.5',fontSize:'0.8rem'}}><span style={{color:'rgb(50, 50, 50)',fontWeight:'500', lineHeight:'1.5'}}> Location d'équipement: </span>{ecole.location?'Oui':'Non'}</p>
                <p style={{lineHeight:'1.5',fontSize:'0.8rem'}}><span style={{color:'rgb(50, 50, 50)',fontWeight:'500', lineHeight:'1.5'}}> Autres Services: </span>{ecole.otherService}</p>
                <p style={{lineHeight:'1.5',fontSize:'0.8rem'}}><span style={{color:'rgb(50, 50, 50)',fontWeight:'500', lineHeight:'1.5'}}> Email: </span><a href={'mailto:'+ecole.email}>{ecole.email}</a></p>
                <p style={{lineHeight:'1.5',fontSize:'0.8rem'}}><span style={{color:'rgb(50, 50, 50)',fontWeight:'500', lineHeight:'1.5'}}> Website: </span><a href={ecole.website}>{ecole.website}</a></p>
    ...
    return (
      <div>
        <div className='row ' style={style}>
          ...
          <h1  style={{color:'white', margin:'auto', textShadow:'2px 2px 4px rgba(0,0,0,0.4)', textAlign:'center'}}>ÉCOLES DE KITESURF</h1>
        </div>
        <div className="row">
